      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-base med:text-lg text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-4">
            I design and create user-focused web experiences, bridging the space
            between visual design and frontend development— turning raw ideas
            into stellar digital journeys.
          </p>
